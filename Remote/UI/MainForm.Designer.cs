namespace Remote.UI
{
	partial class MainForm
	{
		...
		private void InitializeComponent() {
			...
			this.sessionTree = new System.Windows.Forms.TreeView();
			this.SuspendLayout();
			// 
			// menuStrip
			// 
			...
			this.sessionTree.DoubleClick += new System.EventHandler(this.sessionTree_DoubleClick);
			// 
			// MainForm
			// 
		...
		private System.Windows.Forms.TreeView sessionTree;
	}
}
